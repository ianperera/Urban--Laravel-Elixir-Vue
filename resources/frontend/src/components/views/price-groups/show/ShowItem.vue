    ...
    <section class="panel-featured">
        <header class="panel-heading panel-with-actions" v-if="curItem.id">
            <h2 class="panel-title">
                <span>Price Group # {{ curItem.id }}</span>
            </h2>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <section class="panel sub-panel">
                            <header class="panel-heading">
                                <h4 class="panel-title">Price Group Details</h4>
                            </header>
                            <div class="panel-body">
                                ...
                                <dl class="dl-horizontal mb-none">
                                    ...
                                    <dt>Name</dt>
                                    <dd>
                                        <span v-if="curItem.name">{{ curItem.name }}</span>
                                        <span v-else>-</span>
                                    </dd>

                                    <dt>Category</dt>
                                    <dd>
                                        <span v-if="curItem.category">{{ curItem.category }}</span>
                                        <span v-else>-</span>
                                    </dd>

                                    <dt>Status</dt>
                                    <dd>{{ curItem.status || '-' }}</dd>
                                </dl>
                            </div>
